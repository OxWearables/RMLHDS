...
As you can see, the cell's output (in this case a plot) is shown below it. Use cells to structure your code and display intermediary output. To investigate variables, you can simply use the `print()` function, as shown in the example below.
